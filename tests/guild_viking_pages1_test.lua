...
-- "Automation" is deliberately absent: that section renders only where the
-- auto* modules are installed (the private plugin repo), and the private
-- guild_viking_pages1_automation_test.lua asserts it there. The public base
-- omits the header rather than drawing rows for features it does not carry.
